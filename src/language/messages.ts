...
const EN_MESSAGES: LanguageMessages = {
  ...
  embedFailed: "Failed to load",
  embedFailedOffline: "You appear to be offline.",
  embedFailedRefused: "The server answered, but will not allow this page to display it.",
  embedFailedTimeout: "The server did not respond in time.",
  embedFailedUnreachable: "The server could not be reached.",
  en: "English",
  ...
  mediaClose: "Close photo",
  mediaExpand: "Expand photo: {{alt}}",
  mediaNext: "Next photo",
  mediaPrevious: "Previous photo",
  mediaSlide: "Slide {{index}}",
  mediaSlideNext: "Next slide",
  mediaSlidePrevious: "Previous slide",
...
const CS_MESSAGES: LanguageMessages = {
  ...
  embedFailed: "Nepodařilo se načíst",
  embedFailedOffline: "Vypadá to, že jste offline.",
  embedFailedRefused: "Server odpověděl, ale nedovolí tuto stránku zobrazit zde.",
  embedFailedTimeout: "Server neodpověděl včas.",
  embedFailedUnreachable: "Server se nepodařilo kontaktovat.",
  en: "Anglictina",
  everything: "Vse",
  extensions: "Pripony",
  files: "Soubory",
  ...
  mediaClose: "Zavřít fotografii",
  mediaExpand: "Zvětšit fotografii: {{alt}}",
  mediaNext: "Další fotografie",
  mediaPrevious: "Předchozí fotografie",
  mediaSlide: "Snímek {{index}}",
  mediaSlideNext: "Další snímek",
  mediaSlidePrevious: "Předchozí snímek",
