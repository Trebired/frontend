...
const EN_MESSAGES: LanguageMessages = {
  ...
  embedFailedBlocked: "Failed to load. This content refused to load here.",
  embedFailedTimeout: "Failed to load. This content did not respond in time.",
  en: "English",
...
const CS_MESSAGES: LanguageMessages = {
  ...
  embedFailedBlocked: "Nepodarilo se nacist. Tento obsah odmita zobrazeni na teto strance.",
  embedFailedTimeout: "Nepodarilo se nacist. Tento obsah neodpovedel vcas.",
  en: "Anglictina",
  everything: "Vse",
  extensions: "Pripony",
  files: "Soubory",
