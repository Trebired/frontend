...
const CS_MESSAGES: LanguageMessages = {
  ...
  mediaClose: "Zavrit fotografii",
  mediaExpand: "Zvetsit fotografii: {{alt}}",
  mediaNext: "Dalsi fotografie",
  mediaPrevious: "Predchozi fotografie",
  mediaSlide: "Snimek {{index}}",
  mediaSlideNext: "Dalsi snimek",
  mediaSlidePrevious: "Predchozi snimek",
